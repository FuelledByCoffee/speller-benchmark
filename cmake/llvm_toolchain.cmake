...
# ---------------------------------------------------------------------------------------
# Standard library: libc++ and ldd linker
#
...
# Expose the prefix for downstream targets (e.g. proto needs static libc++ paths)
...
if(EXISTS "${_LIBCXX_HEADER}" AND EXISTS "${_LIBCXX_LIBRARY}")
    ...
    #
    # This variable is checked by CMake's internal C++23 module support
    # (Modules/Compiler/Clang-CXX.cmake) starting from CMake 3.30.
